...
CRON_EXISTS=$(crontab -l 2>/dev/null | grep -c "scrape_linktree_daily.js" 2>/dev/null || echo "0")
...
if [ "$CRON_EXISTS" -gt 0 ]; then
    ...
    crontab -l 2>/dev/null | grep -v "scrape_linktree_daily.js" | crontab -
fi
...
echo "   Script: $SCRAPER_DIR/scrape_linktree_daily.js"
...
echo "   crontab -l | grep -v 'scrape_linktree_daily.js' | crontab -"
echo ""
echo "To view logs:"
